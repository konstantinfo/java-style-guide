# The Official  Konstant Info Java Style Guide.
...
In __Editor > Code Style__, choose the __Scheme__ to be __konstantinfo.com__:
...
Smiley faces are a very prominent style feature of the konstantinfo.com site!
